...
const rateLimitter_js_1 = require("./middleware/rateLimitter.js");
...
const authMiddleware = new authMiddleware_js_1.AuthMiddleware();
const requestRatelimiter = new rateLimitter_js_1.RateLimiter();
