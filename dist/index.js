...
const handleAllError_1 = __importDefault(require("./middleware/handleAllError"));
const errorDemo_1 = __importDefault(require("./routes/errorDemo"));
...
app.use((0, customHeader_1.default)("Assignment-app", "Backend-training"));
app.use(requestLogger_1.default);
app.use("/api/v1", assignments_1.default);
app.use("/error-demo", errorDemo_1.default);
app.use(handleAllError_1.default);
// Middleware ends
mongoose_1.default
